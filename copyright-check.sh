...
for f in `find . -type f ! -path "./.eslintrc.js" ! -path "./build-harness/*" ! -path "./output/*" ! -path "./sslcert/*" ! -path "./node_modules/*" ! -path "./coverage/*" ! -path "./test-output/*" ! -path "./build/*" ! -path "./nls/*" ! -path "./public/*"`; do
